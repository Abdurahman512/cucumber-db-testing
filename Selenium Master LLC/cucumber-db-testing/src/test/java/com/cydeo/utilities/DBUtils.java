...
public class DBUtils {
    ...
    public static void createConnection(){
        ...
        String url      = ConfigurationReader.get("library2.db.url") ;
        String username = ConfigurationReader.get("library2.db.username") ;
        String password = ConfigurationReader.get("library2.db.password") ;
